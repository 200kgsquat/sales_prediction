...
def run_pipeline(sales_path, items_path, categories_path, shops_path, output_path, model_path) -> int:
    ...
    try:
        ...
        from sales_forecasting.validation.validation_schemas.raw_schema import sale_schema
        ...
        from sales_forecasting.validation.validation_schemas.fe_schema import features_schema
